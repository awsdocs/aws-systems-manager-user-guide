...
1. If you want to begin using this patch baseline as the default for Windows as soon as you create it, select **Make this the default patch baseline for Windows Server** \.
...
1. In the **Approval rules for Windows Server** section, use the fields to create one or more auto\-approval rules\.
...
1. In the list of patch baselines, choose the name of a predefined patch baseline for the operating system you want to patch\.
...
1. Choose the **Approval rules** tab\. 
   ...
   To create a custom patch baseline, in the navigation pane, choose **Patch Manager**, and then choose **Create patch baseline**\.
...
1. If you want to begin using this patch baseline as the default for the selected operating system as soon as you create it, check the **Make this the default patch baseline for the selected operating system** box\.
...
1. In the **Approval rules for *operating\-system*** section, use the fields to create one or more auto\-approval rules\.
