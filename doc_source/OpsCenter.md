...
The following list includes types of CloudWatch Events rules customer configure to create OpsItems\.
...
+ You can view service\-specific and contextually relevant data for OpsItems that are automatically generated by CloudWatch alarms, Amazon EventBridge events, and CloudWatch Application Insights for \.NET and SQL Server\.
