# Creating an Automation Document<a name="automation-createdoc"></a>
...
1. Collect the following information\. You will specify this information later in this procedure\.
   ...
   + Create an AWS Identity and Access Management \(IAM\) instance profile role and Automation service role \(or assume role\)\. For more information about these roles and how to quickly create them from an AWS CloudFormation template, see [Method 1: Using AWS CloudFormation to Configure Roles for Automation](automation-setup.md#automation-cf)\. Be sure to copy the name of the instance profile role and the Amazon Resource Name \(ARN\) of the Automation service role, as described in [Copying Role Information for Automation](automation-setup.md#automation-cf-copy)\.
