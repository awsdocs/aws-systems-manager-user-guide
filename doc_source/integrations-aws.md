...
Through the use of Systems Manager Command documents \(SSM documents\) and Automation runbooks, you can use AWS Systems Manager to integrate with many AWS services\. For more information about these resources, see [AWS Systems Manager documents](sysman-ssm-docs.md)\.
