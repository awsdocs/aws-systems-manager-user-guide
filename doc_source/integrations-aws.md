...
|  |  | 
| --- |--- |
| AWS IoT Greengrass core devices |  [AWS IoT Greengrass](https://docs.aws.amazon.com/greengrass/v2/developerguide/) is an open source IoT edge runtime and cloud service that helps you build, deploy and manage IoT applications on your devices\. Systems Manager offers native support for AWS IoT Greengrass core devices\.   Learn more [Setting up Systems Manager for edge devices](systems-manager-setting-up-edge-devices.md)   | 
