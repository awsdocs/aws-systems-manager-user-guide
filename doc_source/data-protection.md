...
For more information, see [What is a parameter?](sysman-paramstore.md#what-is-a-parameter) and [Restricting access to Systems Manager parameters using IAM policies](paramstore-access.md)\.
