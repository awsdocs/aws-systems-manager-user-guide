# AWS Systems Manager Parameter Store<a name="sysman-paramstore"></a>
...
+ **Change notification**
  ...
  You can configure change notifications and trigger automated actions for both parameters and parameter policies\. For more information, see [Setting up notifications or trigger actions based on Parameter Store events](paramstore-cwe.md)\.
...
+ **Integrate with other AWS services**
  ...
  + Amazon CloudWatch: For more information, see [Configuring EventBridge for parameters](paramstore-cwe.md#cwe-parameter-changes)\. 
...
For more information, see [Create a SecureString parameter \(AWS CLI\)](paramstore-create-cli.md#paramstore-create-cli-securestring)\.
...
```
**Related topics**  
For an example of how to create and use a `SecureString` parameter, see [Create a SecureString parameter and join an instance to a Domain \(PowerShell\)](paramstore-walkthroughs.md#sysman-param-securestring-walkthrough)\. For more information about using Systems Manager parameters with other AWS services, see the following blog posts:
...
+ [Setting up Parameter Store](paramstore-setting-up.md)
+ [Working with Parameter Store](paramstore-working-with.md)
+ [Parameter Store walkthroughs](paramstore-walkthroughs.md)
+ [Auditing and logging Parameter Store activity](paramstore-logging-auditing.md)
+ [Troubleshooting Parameter Store](paramstore-troubleshooting.md)