# Creating associations that run Ansible playbooks<a name="sysman-state-ansible"></a>
...
## Installed dependencies<a name="sysman-state-ansible-depedencies"></a>
...
## Create an association that runs Ansible playbooks \(console\)<a name="sysman-state-ansible-console"></a>
...
1. In the **Rate control** section, configure options to run State Manager associations across a fleet of managed instances\. For information about using rate controls, see [About targets and rate controls in State Manager associations](sysman-state-targets-rate-controls.md)\.
...
## Create an association that runs Ansible playbooks \(CLI\)<a name="sysman-state-ansible-cli"></a>
