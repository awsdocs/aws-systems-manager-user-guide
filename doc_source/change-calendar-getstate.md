...
You can get the overall state of a calendar or the state of a calendar at a specific time in AWS Systems Manager Change Calendar\. You can also show the next time that the calendar state changes from `OPEN` to `CLOSED`, or vice versa\.
