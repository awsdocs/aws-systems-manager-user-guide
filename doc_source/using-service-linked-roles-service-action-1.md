...
+ **Explorer:** If you delete the service\-linked role used by Systems Manager Explorer, then the cross\-account and cross\-Region OpsData and OpsItems are no longer viewable\. 
