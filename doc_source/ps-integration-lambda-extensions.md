...
```
GET: /systemsmanager/parameters/get?name=%2Fa%2Fb%2F&label=release
```

To call a public \(global\) parameter, make an HTTP GET call similar to the following\.

```
GET: /systemsmanager/parameters/get/?name=%2Faws%2Fservice%20list%2F…
```
...
```
GET: /systemsmanager/parameters/get?name=arn:aws:ssm:us-east-1:123456789012:parameter%2FMyParameter
```
