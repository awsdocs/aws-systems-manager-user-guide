...
### Get patch summary states per\-managed node<a name="patch-manager-cli-commands-describe-instance-patch-states"></a>
...
### Install patches on managed nodes \(AWS CLI\)<a name="patch-operations-install-cli"></a>
