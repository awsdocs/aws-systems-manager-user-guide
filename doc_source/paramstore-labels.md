# Working with parameter labels<a name="paramstore-labels"></a>
...
**Topics**
+ [Working with parameter labels \(console\)](#paramstore-labels-console)
+ [Working with parameter labels \(AWS CLI\)](#paramstore-labels-cli)

## Working with parameter labels \(console\)<a name="paramstore-labels-console"></a>

This section describes how to perform the following tasks by using the AWS Systems Manager console\.
+ [Create a new parameter label \(console\)](#paramstore-labels-console-create)
+ [View labels attached to a parameter \(console\)](#paramstore-labels-console-view)
+ [Move a parameter label \(console\)](#paramstore-labels-console-move)

### Create a new parameter label \(console\)<a name="paramstore-labels-console-create"></a>
...
### View labels attached to a parameter \(console\)<a name="paramstore-labels-console-view"></a>
...
### Move a parameter label \(console\)<a name="paramstore-labels-console-move"></a>
...
## Working with parameter labels \(AWS CLI\)<a name="paramstore-labels-cli"></a>

This section describes how to perform the following tasks by using the AWS CLI\.
+ [Create a new parameter label \(CLI\)](#paramstore-labels-cli-create)
+ [View labels for a parameter \(CLI\)](#paramstore-labels-cli-view)
+ [View a list of parameters that are assigned a label \(CLI\)](#paramstore-labels-cli-view-param)
+ [Move a parameter label \(CLI\)](#paramstore-labels-cli-move)

### Create a new parameter label \(CLI\)<a name="paramstore-labels-cli-create"></a>
...
### View labels for a parameter \(CLI\)<a name="paramstore-labels-cli-view"></a>
...
### View a list of parameters that are assigned a label \(CLI\)<a name="paramstore-labels-cli-view-param"></a>
...
### Move a parameter label \(CLI\)<a name="paramstore-labels-cli-move"></a>
