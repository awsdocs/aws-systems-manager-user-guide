...
In our example, you create a maintenance window that runs every five minutes\. Normally, you wouldn't run a maintenance window this frequently\. However, this rate lets you see your tutorial results quickly\. We will show you how to change to a less frequent rate after the task has run successfully\.
