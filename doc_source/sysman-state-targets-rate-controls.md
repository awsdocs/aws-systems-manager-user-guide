# About targets and rate controls in State Manager associations<a name="sysman-state-targets-rate-controls"></a>
...
## Targets<a name="sysman-state-targets-rate-controls-about-targets"></a>
...
## Rate controls<a name="sysman-state-targets-rate-controls-about-controls"></a>
