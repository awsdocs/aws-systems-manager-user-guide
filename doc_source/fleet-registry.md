...
You can use AWS Systems Manager Fleet Manager \(Fleet Manager\) to manage the registry on your Windows instances\. From the Fleet Manager console you can create, copy, update, and delete registry entries and values\.
