...
**Before you begin**  
If you have not already, install and configure the AWS CLI or the AWS Tools for PowerShell\. For information, see [Install or upgrade AWS command line tools](getting-started-cli.md)\.
