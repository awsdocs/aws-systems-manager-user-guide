...
+ [Configuring EventBridge for parameters](paramstore-cwe.md#cwe-parameter-changes)
+ [Configuring EventBridge for parameter policies](paramstore-cwe.md#cwe-parameter-policy-status)