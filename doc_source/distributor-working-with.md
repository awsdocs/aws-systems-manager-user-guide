...
+ Have an Amazon Simple Storage Service \(Amazon S3\) bucket ready to store your installable assets or software\. If you are using the **Advanced** package creation process, upload your assets to the Amazon S3 bucket before you begin\.
**Note**  
