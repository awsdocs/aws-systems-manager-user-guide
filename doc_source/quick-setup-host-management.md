...
Quick Setup for individual Amazon Web Services accounts is available in all AWS Regions where Systems Manager is supported\. For a list of supported Regions, see the **Region** column in [Systems Manager service endpoints](https://docs.aws.amazon.com/general/latest/gr/ssm.html#ssm_region) in the *Amazon Web Services General Reference*\.
...
1. In the **Configuration options** section, choose the options you want to enable for your configuration\.
   ...
   For more information about AWS Systems Manager Inventory, see [AWS Systems Manager Inventory](systems-manager-inventory.md)\.
