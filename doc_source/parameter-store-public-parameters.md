...
+ [Calling public parameters for AWS services, Regions, endpoints, availability zones, and local zones](parameter-store-public-parameters-global-infrastructure.md)