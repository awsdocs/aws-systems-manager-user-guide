...
+ **Filters**: Each widget offers the ability to filter information based on Amazon Web Services account, AWS Region, and tag\. Filters help you quickly refine the information displayed in Explorer\.
...
+ **Three modes of Amazon Web Services account and AWS Region display**: Explorer includes the following display modes for OpsData and OpsItems in Amazon Web Services accounts and AWS Regions:
