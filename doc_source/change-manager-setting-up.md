...
You can use AWS Systems Manager Change Manager \(Change Manager\) to manage changes for an entire organization, as configured in AWS Organizations, or for a single AWS account\. 
