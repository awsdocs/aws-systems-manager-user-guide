...
+ [I want to allow people outside of my Amazon Web Services account to access my Systems Manager resources](#security_iam_troubleshoot-cross-account-access)
...
## I'm an administrator and want to allow others to access Systems Manager<a name="security_iam_troubleshoot-admin-delegate"></a>
...
## I want to allow people outside of my Amazon Web Services account to access my Systems Manager resources<a name="security_iam_troubleshoot-cross-account-access"></a>
