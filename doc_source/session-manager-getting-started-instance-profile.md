...
However,  if you want to provide a narrower set of instance permissions, or if you have created a custom policy for your instance profile, do one of the following to allow Session Manager actions to be performed on your instances:
