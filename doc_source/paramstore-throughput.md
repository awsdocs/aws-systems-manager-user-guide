# Increasing Parameter Store throughput<a name="paramstore-throughput"></a>
...
**Topics**
+ [Configuring permissions to increase Parameter Store throughput](#paramstore-throughput-permissions)
+ [Increasing throughput \(console\)](#paramstore-throughput-increasing)
+ [Increasing throughput \(AWS CLI\)](#paramstore-throughput-increasing-cli)
+ [Increasing throughput \(PowerShell\)](#paramstore-throughput-increasing-ps)

## Configuring permissions to increase Parameter Store throughput<a name="paramstore-throughput-permissions"></a>
...
1. On the **Review policy** page, for **Name**, enter a name for the inline policy, such as **paramstore\-throughput** or another name you prefer\.
...
## Increasing throughput \(console\)<a name="paramstore-throughput-increasing"></a>
...
**Tip**  
If you haven't created a parameter yet, you can use the AWS CLI or AWS Tools for Windows PowerShell to increase throughput\. For information, see [Increasing throughput \(AWS CLI\)](#paramstore-throughput-increasing-cli) and [Increasing throughput \(PowerShell\)](#paramstore-throughput-increasing-ps)\.
...
## Increasing throughput \(AWS CLI\)<a name="paramstore-throughput-increasing-cli"></a>
...
## Increasing throughput \(PowerShell\)<a name="paramstore-throughput-increasing-ps"></a>
