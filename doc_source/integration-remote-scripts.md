...
+ Ensure that the instance profile on your EC2 instances has `s3:ListBucket` permissions\. If the instance profile doesn't have this permission, the system fails to download your script from the S3 bucket\. For more information, see [Using instance profiles](https://docs.aws.amazon.com/IAM/latest/UserGuide/id_roles_use_switch-role-ec2_instance-profiles.html) in the *IAM User Guide*\. 
