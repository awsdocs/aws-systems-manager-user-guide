# Native parameter support for Amazon Machine Image IDs<a name="paramstore-ec2-aliases"></a>
...
For information about subscribing to Parameter Store events in EventBridge, see [Setting up notifications or trigger actions based on Parameter Store events](paramstore-cwe.md)\.