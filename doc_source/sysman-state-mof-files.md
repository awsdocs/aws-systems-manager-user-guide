# Creating associations that run MOF files<a name="sysman-state-mof-files"></a>
...
**Topics**
+ [Using Amazon S3 to store artifacts](#sysman-state-mof-files-S3-storage)
+ [Resolving credentials in MOF files](#sysman-state-mof-files-credentials)
+ [Using tokens in MOF files](#sysman-state-mof-files-tokens)
+ [Prerequisites](#sysman-state-mof-files-prereqs)
+ [Creating an association that runs MOF files](#sysman-state-mof-files-creating)
+ [Troubleshooting](#sysman-state-mof-files-troubleshooting)
+ [Viewing DSC resource compliance details](#systems-manager-state-manager-viewing-mof-file-compliance)

## Using Amazon S3 to store artifacts<a name="sysman-state-mof-files-S3-storage"></a>
...
## Resolving credentials in MOF files<a name="sysman-state-mof-files-credentials"></a>

Credentials are resolved by using [AWS Secrets Manager](https://docs.aws.amazon.com/secretsmanager/latest/userguide/) or [AWS Systems Manager Parameter Store](sysman-paramstore.md)\. This allows you to set up automatic credential rotation\. This also enables DSC to automatically propagate credentials to your servers without redeploying MOFs\.
...
## Using tokens in MOF files<a name="sysman-state-mof-files-tokens"></a>
...
## Prerequisites<a name="sysman-state-mof-files-prereqs"></a>
...
## Creating an association that runs MOF files<a name="sysman-state-mof-files-creating"></a>
...
1. In the **Rate control** section, configure options for running State Manager associations across of fleet of managed instances\. For more information about these options, see [About targets and rate controls in State Manager associations](sysman-state-targets-rate-controls.md)\.
...
## Troubleshooting<a name="sysman-state-mof-files-troubleshooting"></a>
...
### Common problems<a name="sysman-state-mof-files-troubleshooting-common"></a>
