...
+ [Audit session activity in your Amazon Web Services account using AWS CloudTrail](session-manager-auditing.md)\.
+ [Log session data in your Amazon Web Services account using Amazon CloudWatch Logs or Amazon S3](session-manager-logging.md)\.
