# Restricting access to Systems Manager parameters using IAM policies<a name="paramstore-access"></a>
...
+ [Allowing only specific parameters to run on instances](#paramstore-access-inst)
...
## Allowing only specific parameters to run on instances<a name="paramstore-access-inst"></a>
