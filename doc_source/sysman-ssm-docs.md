...
To identify the required and optional parameters for an SSM document, in addition to the actions it runs, you can view the content of the document in the Systems Manager console\. For information, see [Viewing SSM Command document content](viewing-ssm-document-content.md)\.
