# Identity and access management for AWS Systems Manager<a name="security-iam"></a>
...
For information about AWS managed policies for Systems Manager, see [AWS managed policies for AWS Systems Manager](security_iam_service-with-iam.md#managed-policies)\.
