# Assigning parameter policies<a name="paramstore-policies"></a>
...
**Note**  
Parameter policies are available for parameters that use the advanced parameters tier\. For more information, see [Managing parameter tiers](paramstore-advanced-parameters.md)\.
