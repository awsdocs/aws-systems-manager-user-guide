...
As a managed service, AWS Systems Manager is protected by the AWS global network security procedures that are described under [Best Practices for Security, Identity, & Compliance](http://aws.amazon.com/architecture/security-identity-compliance/)\.
