...
1. \(Optional\) For **Output options**, to save the command output to a file, select the **Enable writing to S3** box\. Type the bucket and prefix \(folder\) names in the boxes\.
