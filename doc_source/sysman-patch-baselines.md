...
For information about creating a patch baseline, see [Create a custom patch baseline](sysman-patch-baseline-console.md) and [Walkthrough: Patch a server environment \(AWS CLI\)](sysman-patch-cliwalk.md)\.
