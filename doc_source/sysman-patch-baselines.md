...
For information about creating a patch baseline, see [Create a custom patch baseline](sysman-patch-baseline-console.md) and [Walkthrough: Patch a server environment \(command line\)](sysman-patch-cliwalk.md)\.