...
The following example expands on how to update a Windows AMI, as described in [Patch a Windows AMI](automation-createdoc.md)\. This example uses the model where an organization maintains and periodically patches their own, proprietary AMIs rather than building from Amazon EC2 AMIs\.
