...
+ The following resources can help you work directly with Systems Manager\.
  ...
  + **[AWS Systems Manager Service Level Agreement](https://aws.amazon.com/systems-manager/sla/)** – The AWS Systems Manager Service Level Agreement \(SLA\) is a policy governing the use of AWS Systems Manager and applies separately to each AWS account using AWS Systems Manager\.
