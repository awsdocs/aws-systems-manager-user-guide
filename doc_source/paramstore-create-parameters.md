# Creating Systems Manager parameters<a name="paramstore-create-parameters"></a>
...
This section will show you how to create, store, and run parameters with Parameter Store in a test environment\. It will also show you how to use Parameter Store with other Systems Manager capabilities and AWS services\. For more information, see [What is a parameter?](sysman-paramstore.md#what-is-a-parameter)
...
+ [Create a Systems Manager parameter \(console\)](paramstore-create-console.md)
+ [Create a Systems Manager parameter \(AWS CLI\)](paramstore-create-cli.md)
+ [Create a Systems Manager parameter \(Tools for Windows PowerShell\)](paramstore-create-ps.md)